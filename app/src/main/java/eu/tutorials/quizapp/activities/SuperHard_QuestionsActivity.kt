...
class SuperHard_QuestionsActivity : BaseActivity(), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        setContentView(R.layout.activity_super_hard_questions)

        mDifficultyLevel = intent.getStringExtra(Constants.DIFFICULTY_LEVEL)
        mUserName = intent.getStringExtra(Constants.USER_NAME)

        progressBar = findViewById(R.id.progressBar_super_hard)
        tvProgress = findViewById(R.id.tv_progress_super_hard)
        tvQuestion = findViewById(R.id.tv_question_super_hard)
        ivImage = findViewById(R.id.iv_image_super_hard)

        tvOptionOne = findViewById(R.id.tv_option_one_super_hard)
        tvOptionTwo = findViewById(R.id.tv_option_two_super_hard)
        tvOptionThree = findViewById(R.id.tv_option_three_super_hard)
        tvOptionFour = findViewById(R.id.tv_option_four_super_hard)
        btnSubmit = findViewById(R.id.btn_submit_super_hard)
        btnGoBack = findViewById(R.id.btn_go_back_super_hard)
        ...
        mQuestionsList = Constants.getSuperHardQuestions()
    ...
    override fun onClick(view: View?) {
        when(view?.id){
            R.id.tv_option_one_super_hard -> {
                tvOptionOne?.let {
                    selectedOptionView(it,1)
                }
            }
            R.id.tv_option_two_super_hard -> {
                tvOptionTwo?.let {
                    selectedOptionView(it,2)
                }
            }
            R.id.tv_option_three_super_hard -> {
                tvOptionThree?.let {
                    selectedOptionView(it,3)
                }
            }
            R.id.tv_option_four_super_hard -> {
                tvOptionFour?.let {
                    selectedOptionView(it,4)
                }
            }

            R.id.btn_submit_super_hard -> {
