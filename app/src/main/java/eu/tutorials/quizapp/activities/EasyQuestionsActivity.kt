...
class EasyQuestionsActivity : BaseActivity(), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        setContentView(R.layout.activity_easy_quiz_questions)
        ...
        mQuestionsList = Constants.getEasyQuestions()
