...
class HardQuestionsActivity : BaseActivity(), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        progressBar = findViewById(R.id.progressBar_hard)
        tvProgress = findViewById(R.id.tv_progress_hard)
        tvQuestion = findViewById(R.id.tv_question_hard)
        ivImage = findViewById(R.id.iv_image_hard)

        tvOptionOne = findViewById(R.id.tv_option_one_hard)
        tvOptionTwo = findViewById(R.id.tv_option_two_hard)
        tvOptionThree = findViewById(R.id.tv_option_three_hard)
        tvOptionFour = findViewById(R.id.tv_option_four_hard)
        btnSubmit = findViewById(R.id.btn_submit_hard)
        btnGoBack = findViewById(R.id.btn_go_back_hard)
        ...
        mQuestionsList = Constants.getHardQuestions()
    ...
    override fun onClick(view: View?) {
        when(view?.id){
            R.id.tv_option_one_hard -> {
                tvOptionOne?.let {
                    selectedOptionView(it,1)
                }
            }
            R.id.tv_option_two_hard -> {
                tvOptionTwo?.let {
                    selectedOptionView(it,2)
                }
            }
            R.id.tv_option_three_hard -> {
                tvOptionThree?.let {
                    selectedOptionView(it,3)
                }
            }
            R.id.tv_option_four_hard -> {
                tvOptionFour?.let {
                    selectedOptionView(it,4)
                }
            }

            R.id.btn_submit_hard -> {
